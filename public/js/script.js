    ...
    angular
        ...
        function bookingProfileController( bookingService , $state , Http){ 
            ...
            vm.$onInit = function(){
                ...
                if(!vm.booking.patient) vm.booking.patient = {date_of_birth:'01/01/1990', country_id: 'MY'};
    ...
    function dashboardBookingsController(Http, Dashboard, $state, CSV, $document, $timeout) {
        ...
        function init_filter(){
            vm.filter = {
                location_id: 0,
                status:1,
                booking_date_start: current_date,
                booking_date_end: current_date,
            };
        }
                ...
                if(vm.booking.slot){
                    Http
                        ...
                        function(res){
                            ...
                            vm.bookingDetails.slot_time_with_interval = res.data.slot_time_with_interval;
